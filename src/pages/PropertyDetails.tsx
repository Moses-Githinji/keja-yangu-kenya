...
import { ArrowLeft, Heart, Share2, MapPin, Bed, Bath, Square, Calendar, MessageCircle, Phone } from "lucide-react";
...
const PropertyDetails = () => {
  ...
  const property = {
    ...
    area: 350,
    yearBuilt: 2022,
    description: "This stunning luxury villa offers breathtaking ocean views and modern amenities. Located in the prestigious Nyali area, this property features spacious rooms, a private pool, and beautifully landscaped gardens.",
    features: [
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Tabs defaultValue="description" className="w-full">
              ...
              <TabsContent value="location" className="space-y-4">
                <div className="h-64">
                  <PropertyMap className="rounded-lg" />
                </div>
              </TabsContent>
            </Tabs>
          </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="text-2xl font-bold text-primary">KSh 150,000</div>
                  </div>
                  <Button variant="outline" className="w-full">
                    Calculate Details
                  </Button>
